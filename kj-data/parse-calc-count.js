...
// 时时彩龙虎和中奖函数 qq63032979
//龙 
exports.ssc_lhh_l=function(betData, kjData){
kjData=kjData.split(',');betData=betData.split(' ');
var qq63032979 = 0;
for(var i=0;i<betData.length;i++){
	if(betData[i] =='万千' && kjData[0]>kjData[1])  qq63032979+=1;
	if(betData[i] =='万百' && kjData[0]>kjData[2])  qq63032979+=1;
	if(betData[i] =='万十' && kjData[0]>kjData[3])  qq63032979+=1;
	if(betData[i] =='万个' && kjData[0]>kjData[4])  qq63032979+=1;
	if(betData[i] =='千百' && kjData[1]>kjData[2])  qq63032979+=1;
	if(betData[i] =='千十' && kjData[1]>kjData[3])  qq63032979+=1;
	if(betData[i] =='千个' && kjData[1]>kjData[4])  qq63032979+=1;
	if(betData[i] =='百十' && kjData[2]>kjData[3])  qq63032979+=1;
	if(betData[i] =='百个' && kjData[2]>kjData[4])  qq63032979+=1;
	if(betData[i] =='十个' && kjData[3]>kjData[4])  qq63032979+=1;
 }
 return qq63032979;

}
//虎
exports.ssc_lhh_h=function(betData, kjData){
kjData=kjData.split(',');betData=betData.split(' ');
var qq63032979 = 0;
for(var i=0;i<betData.length;i++){
	if(betData[i] =='万千' && kjData[0]<kjData[1])  qq63032979+=1;
...
//和
exports.ssc_lhh_he=function(betData, kjData){
kjData=kjData.split(',');betData=betData.split(' ');
var qq63032979 = 0;
for(var i=0;i<betData.length;i++){
	if(betData[i] =='万千' && kjData[0]==kjData[1])  qq63032979+=1;
...
//// 时时彩五星总和大小单双中奖函数 qq63032979
exports.ssc_dxds_5x=function(betData, kjData){
kjData=kjData.split(',');betData=betData.split('');
var qq63032979 = 0;
var sum = 0;
sum = parseInt(kjData[0],10)+parseInt(kjData[1],10)+parseInt(kjData[2],10)+parseInt(kjData[3],10)+parseInt(kjData[4],10);
for(var i=0;i<betData.length;i++){
	if(betData[i] =='单' && sum%2!=0)  qq63032979+=1;
	if(betData[i] =='双' && sum%2==0)  qq63032979+=1;
	if(betData[i] =='大' && sum>22)  qq63032979+=1;
	if(betData[i] =='小' && sum<23)  qq63032979+=1;
 	
 }
	return qq63032979;
}
//// 牛牛玩法中奖函数 qq63032979
// 此函数已废弃 此函数会出现中奖按位置排序多算中奖注数 而要达到的效果是按号码排序相加
// 本想继续完善 但是客户给的时间不多 于是就用了比较直接但是略显冗杂的规则 
/* exports.niuniu=function(betData, kjData){
	var qq63032979 = 0;betData=betData.split(' ');kjData=kjData.split(',');
	var cn = ['牛','一','二','三','四','五','六','七','八','九','牛'];
	for(var i = 0;i<3;i++){
		for(var a = 1;a<4;a++){
			for(var b = 2;b<5;b++){
			if(i == a || a == b || i == b) continue;
			var c = 0;
			c = parseInt(kjData[i],10)+parseInt(kjData[a],10)+parseInt(kjData[b],10);
			var d=[i,a,b];
			if(Math.max.apply(null, d)-Math.min.apply(null, d)>1){
			 if(c%10 == 0) {
			 var data = [];
			 data.push(kjData[i]);
			 data.push(kjData[a]);
			 data.push(kjData[b]);
			 for(var l = 0;l<5;l++){
				if(d.indexOf(l) == -1) data.push(kjData[l]);
			  }
			var niu = parseInt(data[3])+parseInt(data[4]);
			if(niu>10) niu=niu-10;
			var check = '牛'+cn[niu];
			 if(betData.indexOf(check)!=-1) {
				 delete cn[betData.indexOf(check)];
				 qq63032979+=1;
				 }
        }else{
		 //return 0;//没牛
...
exports.niuniu=function(betData, kjData){
var qq63032979 = 0;betData=betData.split(' ');kj=kjData.split(',');
	...
	if((parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[2],10))%10 ==0 ){
		...
		var b = '牛'+cn[a];
		if(betData.indexOf(b)!=-1) qq63032979=1; 
	 }
...
//// 牛牛没牛玩法中奖函数 qq63032979
exports.niuniufalse=function(betData, kjData){
		var qq63032979 = 0;betData=betData.split(' ');kjData=kjData.split(',');
	var cn = ['牛','一','二','三','四','五','六','七','八','九','牛'];
	for(var i = 0;i<3;i++){
		for(var a = 1;a<4;a++){
 ...
 if(qq63032979>0) qq63032979=0;
 else qq63032979=1;
 return qq63032979;
 }
//// 牛牛大小单双玩法中奖函数 qq63032979
exports.niuniudxds=function(betData, kjData){
	var qq63032979 = 0;betData=betData.split('');kj=kjData.split(',');
	var cn = ['牛','一','二','三','四','五','六','七','八','九','牛'];
	if((parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[2],10))%10 ==0 ){
		var a =parseInt(kj[3])+parseInt(kj[4]);if(a<1) a=a+10;
		if(a<11 && a>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a<11 && a<6 && betData.indexOf('小')!=-1) qq63032979=1;
		if(a>10 && a%10>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a>10 && a%10<6 && betData.indexOf('小')!=-1) qq63032979=1;
		if(a%2==0 && betData.indexOf('双')!=-1) qq63032979+=1;
		if(a%2!=0 && betData.indexOf('单')!=-1) qq63032979+=1;
	 }
	if((parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[3],10))%10 ==0 ){
		var a =parseInt(kj[2])+parseInt(kj[4]);if(a<1) a=a+10;
		if(a<11 && a>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a<11 && a<6 && betData.indexOf('小')!=-1) qq63032979=1;
		if(a>10 && a%10>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a>10 && a%10<6 && betData.indexOf('小')!=-1) qq63032979=1;
	...
	if((parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[4],10))%10 ==0 ){
		var a =parseInt(kj[2])+parseInt(kj[3]);if(a<1) a=a+10;
		if(a<11 && a>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a<11 && a<6 && betData.indexOf('小')!=-1) qq63032979=1;
		if(a>10 && a%10>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a>10 && a%10<6 && betData.indexOf('小')!=-1) qq63032979=1;
	...
	if((parseInt(kj[0],10)+parseInt(kj[2],10)+parseInt(kj[3],10))%10 ==0 ){
		var a =parseInt(kj[1])+parseInt(kj[4]);if(a<1) a=a+10;
		if(a<11 && a>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a<11 && a<6 && betData.indexOf('小')!=-1) qq63032979=1;
		if(a>10 && a%10>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a>10 && a%10<6 && betData.indexOf('小')!=-1) qq63032979=1;
	...
	if((parseInt(kj[0],10)+parseInt(kj[2],10)+parseInt(kj[4],10))%10 ==0 ) {
		var a =parseInt(kj[1])+parseInt(kj[3]);if(a<1) a=a+10;
		if(a<11 && a>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a<11 && a<6 && betData.indexOf('小')!=-1) qq63032979=1;
		if(a>10 && a%10>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a>10 && a%10<6 && betData.indexOf('小')!=-1) qq63032979=1;
	...
	if((parseInt(kj[0],10)+parseInt(kj[3],10)+parseInt(kj[4],10))%10 ==0 ){
		var a =parseInt(kj[1])+parseInt(kj[2]);if(a<1) a=a+10;
		if(a<11 && a>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a<11 && a<6 && betData.indexOf('小')!=-1) qq63032979=1;
		if(a>10 && a%10>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a>10 && a%10<6 && betData.indexOf('小')!=-1) qq63032979=1;
	...
	if((parseInt(kj[1],10)+parseInt(kj[2],10)+parseInt(kj[3],10))%10 ==0 ) {
		var a =parseInt(kj[0])+parseInt(kj[4]);if(a<1) a=a+10;
		if(a<11 && a>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a<11 && a<6 && betData.indexOf('小')!=-1) qq63032979=1;
		if(a>10 && a%10>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a>10 && a%10<6 && betData.indexOf('小')!=-1) qq63032979=1;
	...
	if((parseInt(kj[1],10)+parseInt(kj[2],10)+parseInt(kj[4],10))%10 ==0 ) {
		var a =parseInt(kj[0])+parseInt(kj[3]);if(a<1) a=a+10;
		if(a<11 && a>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a<11 && a<6 && betData.indexOf('小')!=-1) qq63032979=1;
		if(a>10 && a%10>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a>10 && a%10<6 && betData.indexOf('小')!=-1) qq63032979=1;
	...
	if((parseInt(kj[1],10)+parseInt(kj[3],10)+parseInt(kj[4],10))%10 ==0 ) {
		var a =parseInt(kj[0])+parseInt(kj[2]);if(a<1) a=a+10;
		if(a<11 && a>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a<11 && a<6 && betData.indexOf('小')!=-1) qq63032979=1;
		if(a>10 && a%10>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a>10 && a%10<6 && betData.indexOf('小')!=-1) qq63032979=1;
	...
	if((parseInt(kj[2],10)+parseInt(kj[3],10)+parseInt(kj[4],10))%10 ==0 ) {
		var a =parseInt(kj[0])+parseInt(kj[1]);if(a<1) a=a+10;
		if(a<11 && a>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a<11 && a<6 && betData.indexOf('小')!=-1) qq63032979=1;
		if(a>10 && a%10>5 && betData.indexOf('大')!=-1) qq63032979=1;
		if(a>10 && a%10<6 && betData.indexOf('小')!=-1) qq63032979=1;
